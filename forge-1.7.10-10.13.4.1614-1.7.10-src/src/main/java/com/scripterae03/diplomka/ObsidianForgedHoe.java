...
public class ObsidianForgedHoe extends ItemHoe{

	public ObsidianForgedHoe(String name, String texture, ToolMaterial p_i45343_1_) {
	...
	{
		info.add("§bWHY SHOULD YOU CRAFT IT????");
		info.add("§bЗАЧЕМ НАДО БЫЛО ЕГО КРАФТИТЬ????");
	}
}
