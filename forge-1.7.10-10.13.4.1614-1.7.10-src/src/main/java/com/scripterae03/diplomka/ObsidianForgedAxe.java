...
public class ObsidianForgedAxe extends ItemAxe {
	protected ObsidianForgedAxe(String name, String texture, ToolMaterial p_i45327_1_) {
	...
	{
		info.add("§bCut down large forests!");
		info.add("§bВырубайте большие леса!");
	}
}
