...
public class Besh extends ItemFood {

	public Besh(String name, String texture, int amount, float saturation, boolean isWrongFood) {
	...
	{
		info.add("§bKazakh national food, gives speed.");
		info.add("§bКазахская национальная еда, придает скорость.");
	}
}
